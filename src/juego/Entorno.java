...
public class Entorno extends JFrame
{
    ...
    {
		this.juego = juego;		
		tablero = new Tablero(this.juego);
...
//		this.setLayout(new BorderLayout());		
        ...
        System.out.println("Entorno (Entorno = fps + bola + tablero + GUI ) de desarrollo 2D para Java de Programacion ");
    }
	...
	{
		return tablero.estaPresionada(key);
	}
