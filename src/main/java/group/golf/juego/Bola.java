...
public class Bola {
	...
	private File loc = new File("src/main/java/group/golf/img/pelota.png");
	...
	private void enTeleport(Entorno entorno) {
		...
		do {
			aux[0] = JuegoMain.generarRandom(8, entorno.ancho()-8, 1);
			aux[1] = JuegoMain.generarRandom(40, entorno.alto()-8, 1);
